...
/*
  ...
  */
  ...
  onChange={(event) => { // Manipulador de evento para atualizar o estado "nickname"
...
/>
  ...
  onChange={(event) => { // Manipulador de evento para atualizar o estado "cpf"
    setCpf(event.target.value);
  }}
  onBlur={(event) => { // Manipulador de evento para executar a validação do CPF ao perder o foco
...
/>
  ...
  />
      {/* Opção de novidades */}
      <FormControlLabel
  control={ // Componente de controle: Switch
    <Switch
      checked={news} // Estado do switch (marcado ou não)
      onChange={(event) => { // Manipulador de evento para atualizar o estado "news"
